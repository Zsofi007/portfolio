        ...
        {childAppIds.map((id) => {
          ...
          return (
            <li key={id} className="list-none shrink-0">
              <button
                type="button"
                title={ios ? undefined : tip ?? app.label}
                ...
                className={
                  ios
                    ? 'relative inline-flex max-w-full cursor-pointer flex-col items-center gap-1.5 rounded-2xl border-0 bg-transparent px-2 py-2 text-center outline-none transition ' +
                      ...
                      (featured ? 'ring-2 ring-[#007aff] shadow-[0_0_22px_rgb(0_122_255/0.28)]' : '')
                    : 'relative inline-flex max-w-full cursor-pointer flex-col items-center gap-1.5 rounded-lg border-0 bg-transparent px-2 py-2 text-center outline-none transition ' +
                      ...
                      (featured ? 'ring-2 ring-[color:var(--color-xp-teal)] shadow-[0_0_18px_rgb(26_107_26/0.45)]' : '')
                }
                onClick={() => open(app)}
              >
                <span
                ...
                >
                  {ios && isSiri ? (
                    ...
                    <AppIconGlyph icon={app.icon} imgClassName="h-10 w-10 object-contain" textClassName="text-2xl" />
                  )}
                </span>
                <span
                  className={
